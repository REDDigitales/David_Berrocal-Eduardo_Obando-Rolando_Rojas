...
set_property PACKAGE_PIN U9 [get_ports {rgb_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb_in[1]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {rgb_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb_in[0]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {rgb_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {rgb_in[2]}]
...
set_property PACKAGE_PIN A4 [get_ports {rgb_out[2]}]
...
set_property PACKAGE_PIN D8 [get_ports {rgb_out[1]}]
